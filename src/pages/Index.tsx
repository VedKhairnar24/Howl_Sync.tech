...
const Index = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-tech-blue to-tech-indigo text-white relative overflow-hidden hero-responsive">
        {/* Background effects */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-10 left-10 w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-full animate-pulse"></div>
          <div className="absolute top-20 right-20 w-12 h-12 sm:w-16 sm:h-16 bg-cyan-300 rounded-full animate-bounce"></div>
          <div className="absolute bottom-10 left-1/4 w-8 h-8 sm:w-12 sm:h-12 bg-blue-800 rounded-full animate-ping"></div>
          <div className="absolute top-1/2 left-1/3 w-6 h-6 sm:w-8 sm:h-8 bg-purple-300 rounded-full animate-pulse"></div>
          <div className="absolute bottom-20 right-1/4 w-10 h-10 sm:w-14 sm:h-14 bg-indigo-300 rounded-full animate-bounce"></div>
          
          {/* Additional floating elements */}
          <div className="absolute top-1/4 right-1/3 w-4 h-4 sm:w-6 sm:h-6 bg-yellow-400 rounded-full animate-float-slow"></div>
          <div className="absolute bottom-1/3 left-1/5 w-6 h-6 sm:w-10 sm:h-10 bg-pink-400 rounded-full animate-rotate-slow"></div>
          <div className="absolute top-3/4 right-1/5 w-5 h-5 sm:w-8 sm:h-8 bg-green-400 rounded-full animate-bounce-slow"></div>
          
          {/* Particle effects */}
          <div className="absolute top-1/2 left-1/2 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-white rounded-full animate-particle-1"></div>
          <div className="absolute top-1/3 right-1/4 w-1 h-1 sm:w-1.5 sm:h-1.5 bg-cyan-300 rounded-full animate-particle-2"></div>
          <div className="absolute bottom-1/3 left-1/3 w-0.5 h-0.5 sm:w-1 sm:h-1 bg-purple-300 rounded-full animate-particle-3"></div>
        </div>
        
        <div className="container mx-auto px-4 py-8 sm:py-12 md:py-16 lg:py-20 relative z-10">
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 lg:pr-12 mb-8 lg:mb-0">
              <Badge className="bg-white/20 text-white mb-4 backdrop-blur-sm animate-fade-in-up badge-responsive">For Beginners & Tech Students</Badge>
              <h1 className="responsive-heading font-bold mb-4 sm:mb-6 animate-typewriter">
                <span className="bg-gradient-to-r from-white to-cyan-200 bg-clip-text text-transparent">
                  Start Your Tech Journey <br className="hidden sm:block"/>
                  with Confidence
                </span>
              </h1>
              <p className="responsive-text mb-6 sm:mb-8 text-blue-100 animate-fade-in-up delay-300">
              ...
              <div className="btn-group-responsive animate-fade-in-up delay-500">
                <Link to="/learning-paths" className="btn-responsive bg-white/20 backdrop-blur-sm rounded-full text-white border border-white/30 hover:bg-white/30 transition-all duration-300 hover:scale-105 inline-block text-center">
                  Start Learning
                </Link>
                <Link to="/community" className="btn-responsive bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full text-white hover:from-cyan-500 hover:to-blue-600 transition-all duration-300 hover:scale-105 shadow-lg inline-block text-center">
                  Join Community
                </Link>
              </div>
            </div>
            <div className="lg:w-1/2 mt-8 lg:mt-0">
              <div className="relative animate-float">
                ...
                <div className="absolute -top-4 -left-4 -right-4 -bottom-4 sm:-top-6 sm:-left-6 sm:-right-6 sm:-bottom-6 bg-gradient-to-r from-purple-400 to-indigo-400 opacity-30 blur-lg rounded-xl animate-pulse"></div>
                <div className="absolute -top-6 -left-6 -right-6 -bottom-6 sm:-top-8 sm:-left-8 sm:-right-8 sm:-bottom-8 bg-gradient-to-r from-cyan-400 to-blue-500 opacity-20 blur-xl rounded-xl animate-pulse-slow"></div>
                
                {/* Enhanced sparkle effects around the image */}
                <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-2 h-2 sm:w-4 sm:h-4 bg-yellow-400 rounded-full animate-sparkle-1"></div>
                <div className="absolute -bottom-0.5 -left-0.5 sm:-bottom-1 sm:-left-1 w-1.5 h-1.5 sm:w-3 sm:h-3 bg-cyan-400 rounded-full animate-sparkle-2"></div>
                <div className="absolute top-1/2 -right-2 sm:-right-4 w-1 h-1 sm:w-2 sm:h-2 bg-pink-400 rounded-full animate-sparkle-3"></div>
                <div className="absolute top-1/4 -left-1 sm:-left-2 w-1.5 h-1.5 sm:w-2.5 sm:h-2.5 bg-purple-400 rounded-full animate-sparkle-1"></div>
                <div className="absolute top-3/4 -right-3 sm:-right-6 w-1.5 h-1.5 sm:w-3 sm:h-3 bg-green-400 rounded-full animate-sparkle-2"></div>
                <div className="absolute bottom-1/4 -left-2 sm:-left-4 w-1 h-1 sm:w-2 sm:h-2 bg-orange-400 rounded-full animate-sparkle-3"></div>
                
                {/* Floating tech icons */}
                <div className="absolute -top-4 -right-4 sm:-top-8 sm:-right-8 w-4 h-4 sm:w-6 sm:h-6 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center animate-float-slow">
                  <Code className="w-2 h-2 sm:w-4 sm:h-4 text-white" />
                </div>
                <div className="absolute -bottom-3 -left-3 sm:-bottom-6 sm:-left-6 w-3 h-3 sm:w-5 sm:h-5 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center animate-float-slow delay-1000">
                  <BookOpen className="w-1.5 h-1.5 sm:w-3 sm:h-3 text-white" />
                </div>
                
                <div className="relative">
                  <div className="absolute -top-2 -left-2 sm:-top-3 sm:-left-3 md:-top-4 md:-left-4 lg:-top-6 lg:-left-6 bg-tech-purple w-full h-full rounded-xl"></div>
                  <img
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-gray-50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-12 h-12 sm:w-16 sm:h-16 bg-tech-blue rounded-full animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-8 h-8 sm:w-12 sm:h-12 bg-tech-purple rounded-full animate-bounce"></div>
          <div className="absolute top-1/2 left-1/4 w-6 h-6 sm:w-8 sm:h-8 bg-tech-lightblue rounded-full animate-ping"></div>
        </div>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-10 right-20 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-r from-tech-blue to-tech-purple rounded-full animate-pulse"></div>
          <div className="absolute bottom-10 left-20 w-12 h-12 sm:w-20 sm:h-20 bg-gradient-to-r from-tech-purple to-tech-pink rounded-full animate-bounce"></div>
          <div className="absolute top-1/2 right-1/3 w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-r from-tech-lightblue to-tech-blue rounded-full animate-ping"></div>
        </div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-center mb-6 sm:mb-8 lg:mb-12">
      ...
      <section className="py-8 sm:py-12 md:py-16 bg-gradient-to-r from-tech-blue to-tech-lightblue text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute bottom-10 right-10 w-8 h-8 sm:w-16 sm:h-16 bg-cyan-300 rounded-full animate-bounce"></div>
          <div className="absolute top-1/2 left-1/4 w-6 h-6 sm:w-12 sm:h-12 bg-purple-300 rounded-full animate-ping"></div>
        </div>
      ...
      <section className="bg-gray-100 dark:bg-gray-900 py-8 sm:py-12 md:py-16 relative overflow-hidden">
        {/* Background effects */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 right-20 w-10 h-10 sm:w-16 sm:h-16 bg-tech-blue rounded-full animate-pulse"></div>
          <div className="absolute bottom-20 left-20 w-8 h-8 sm:w-12 sm:h-12 bg-tech-purple rounded-full animate-bounce"></div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Button
            ...
            className="bg-tech-blue text-white hover:bg-tech-indigo transition-colors font-semibold px-6 sm:px-8 py-2 sm:py-3 rounded-md shadow-md hover:scale-105 transition-transform duration-300 animate-fade-in-up delay-500 btn-responsive"
          >
