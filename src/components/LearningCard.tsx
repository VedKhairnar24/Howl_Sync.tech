...
const LearningCard = ({
  ...
  const getPathDetails = () => {
    ...
    const pathData = learningPathsData[categoryKey];
    
    // Check if the pathData has the required structure
    if (pathData && typeof pathData === 'object' && 'title' in pathData && 'beginner' in pathData && 'intermediate' in pathData && 'advanced' in pathData) {
      return pathData;
    }
